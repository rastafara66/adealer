...
## 17.0.1.2.0 — 2026-09-06 — перший випуск для Odoo 17

Порт із серії 18.0. Правити не довелось нічого — тема не вживає
версійно-залежного API. Змінено лише номер серії у версії.

### Перевірено

- Встановлення в чисту базу на живому Odoo 17: `installed`.
- Прогін разом із `adealer`: 49 тестів, 0 падінь.
